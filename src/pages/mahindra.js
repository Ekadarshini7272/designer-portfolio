  ...
  return (
    <main style={{ minHeight: "100vh", padding: "96px 24px", background: "#f5f5f2" }}>
      <section style={{ maxWidth: 860, margin: "0 auto" }}>
        ...
        <p style={{ margin: "40px 0 8px", color: "#555" }}>2025-26</p>
        <h1 style={{ margin: 0, fontSize: 48, lineHeight: 1 }}>Mahindra IFVI</h1>
        <p style={{ maxWidth: 680, fontSize: 20, lineHeight: 1.5, color: "#444" }}>
          HMI design work for vehicle screens, including hardware-aware interface
          decisions and a design system with production components.
        </p>
      </section>
    </main>
  );
