...
import gynsec8 from "../../../public/images/L2Images/gynger/gynsec8.png";
    ...
    <section className={styles.homeSection}>
      <Container className={styles.sliderWrapper}>
        <div className={styles.sliderTrack} style={{ transform: `translateX(-${current * 100}%)` }}>
          ...
          {/* ===== SLIDE 11 ===== */}
          <div className={`${styles.slide} ${styles.slideEleven}`}>
            <div className={styles.elevenWrapper}>
              <h2 className={styles.elevenTitle}>Wire-framing & ideation</h2>
              <Row className={`${styles.rowTop} g-4`}>
                <Col md={6}>
                  <div>
                    <Image src={gyn11a} alt="screen 1" className={styles.elevenImg} />
                  </div>
                </Col>
                <Col md={3}>
                  <div>
                    <Image src={gyn11b} alt="screen 2" className={styles.elevenImg} />
                  </div>
                </Col>
                <Col md={3}>
                  <div>
                    <Image src={gyn11c} alt="screen 3" className={styles.elevenImg} />
                  </div>
                </Col>
              </Row>

              {/* ROW 2 */}
              <Row className={`${styles.rowBottom} g-4`}>
                <Col md={8}>
                  <Image src={gyn11d} alt="screen 4" className={styles.elevenImg} />
                </Col>

                <Col md={4}>
                  <Image src={gyn11e} alt="screen 5" className={styles.elevenImg} />
                </Col>
              </Row>
            </div>
          </div>
          {/* ===== SLIDE : Wire-framing & ideation ===== */}
